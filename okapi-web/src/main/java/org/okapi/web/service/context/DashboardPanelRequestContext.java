...
public record DashboardPanelRequestContext(
    String orgId, String dashboardId, String versionId, String rowId, String panelId) {
  public DashboardPanelRequestContext {
    ...
    checkArgument(panelId != null && !panelId.isBlank(), "Panel ID is required");
  }
}
